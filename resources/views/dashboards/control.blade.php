...
<div class="container row my-3 mx-auto">
    <div class="col-3">
        <ul class="list-group  text-center">
            <a href="{{route('panel')}}"<li class="list-group-item bg-dark" style="color:white"><i class="fas fa-user mr-2"></i>@lang('panel.teams')</li></a>
            <a href="{{route('competitions')}}"<li class="list-group-item bg-dark" style="color:white"><i class="fas fa-trophy mr-2"></i>@lang('panel.competitions')</li></a>
            <a href="{{route('fixtures')}}"<li class="list-group-item bg-dark" style="color:white"><i class="fas fa-futbol mr-2"></i>@lang('panel.fixtures')</li></a>
