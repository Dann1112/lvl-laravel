...
<div class="container contenedor text-center my-3 py-3">
        ...
        <p>Somos un conjunto de personas dedicadas a poder llevar hasta tu dispositivo la mejor experiencia competitiva de videojuegos.
          Nacida como una idea organizada por jóvenes mexicanos, poco a poco la comunidad latina ha apostado por confiar en nostros
        ...
        <h4>Junio 2018</h4>
        <p>
          - La comunidad puede ver las estadísticas de sus equipos en "Clasificacion"
        ...
        <h3 class="display-4 my-2" style="color:white">¡ Gracias !</h3>
        <hr>
