...
<div class="tab-content" id="InscriptionTabContent">
    ...
    <div class="tab-pane fade show active" id="newInscription" role="tabpanel" aria-labelledby="tab-Inscription">
      ...
      <form class="text-center" method="POST" action="{{route('player_inscription')}}" enctype="multipart/form-data">

        {{csrf_field()}}

            <div class="form-row text-center my-2">
                <label class="col-form-label col-2 text-light" for="team">@lang('panel.team')&nbsp<span class="text-danger">*</span></label>
                ...
                <div class="form-row text-center my-2">
                    <label class="col-form-label col-2 text-light" for="player">@lang('panel.player')&nbsp<span class="text-danger">*</span></label>
                    <select class="form-control col-10" name="username">
                        <option selected disabled hidden>@lang('panel.choose_option')</option>
